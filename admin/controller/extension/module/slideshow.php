...
class ControllerExtensionModuleSlideshow extends Controller {
	...
	public function index() {
		...
		$this->load->model('extension/module/slideshow');
		...
		if (isset($this->error['OneTitle'])) {
			$data['error_OneTitle'] = $this->error['OneTitle'];
		} else {
			$data['error_OneTitle'] = '';
		}

		if (isset($this->error['TwoTitle'])) {
			$data['error_TwoTitle'] = $this->error['TwoTitle'];
		} else {
			$data['error_TwoTitle'] = '';
		}

		if (isset($this->error['ThreeTitle'])) {
			$data['error_ThreeTitle'] = $this->error['ThreeTitle'];
		} else {
			$data['error_ThreeTitle'] = '';
		}
