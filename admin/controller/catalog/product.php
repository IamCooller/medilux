...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_offer'])) {
			$data['product_offer'] = 1;
		} elseif (!empty($product_info)) {
			$data['product_offer'] = $product_info['product_offer'];
		} else {
			$data['product_offer'] = 0;
		}

		if (isset($this->request->post['product_discond'])) {
			$data['product_discond'] = 1;
		} elseif (!empty($product_info)) {
			$data['product_discond'] = $product_info['product_discond'];
		} else {
			$data['product_discond'] = 0;
		}
