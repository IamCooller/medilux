...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_meta_about'])) {
			$data['config_meta_about'] = $this->request->post['cconfig_meta_about'];
		} else {
			$data['config_meta_about'] = $this->config->get('config_meta_about');
		}
		...
		if (isset($this->request->post['config_faceebook'])) {
			$data['config_faceebook'] = $this->request->post['config_faceebook'];
		} else {
			$data['config_faceebook'] = $this->config->get('config_faceebook');
		}
		...
		if (isset($this->request->post['config_footerLogo'])) {
			$data['config_footerLogo'] = $this->request->post['config_footerLogo'];
		} else {
			$data['config_footerLogo'] = $this->config->get('config_footerLogo');
		}
